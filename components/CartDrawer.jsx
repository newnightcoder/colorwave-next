...
import { deleteItem, toggleCartDrawer } from "../store/actions/cart.action";
...
const CartDrawer = () => {
  ...
  return (
    <Div100vh
      style={{
        transform:
          cartDrawerOpen && !router.pathname.includes("cart")
            ? "translateY(0)"
            : "translateY(-101%)",
        zIndex: 4000,
      }}
        ...
        <div
          style={{
            animation:
              cartDrawerOpen &&
              items.length !== 0 &&
              "750ms fadeIn 100ms forwards",
          }}
          className="opacity-0 w-max h-min relative"
        >
          <h1 className="text-xl md:text-2xl px-4 text-center uppercase">
            Your Cart
          </h1>
          ...
          {items?.length !== 0 ? (
            items.map((item, i) => (
              <div
                ...
                style={{
                  animation:
                    cartDrawerOpen &&
                    items.length !== 0 &&
                    `750ms fadeIn ${200 + i * 100}ms forwards`,
                }}
              ...
              >
                ...
                <div className="w-1/5 text-right text-sm md:pr-2">
